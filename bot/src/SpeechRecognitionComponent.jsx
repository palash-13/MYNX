...
const callApiAndGetInteger3 = () => {
  const speechutterance = new SpeechSynthesisUtterance();
  const apiUrl = 'http://52.14.102.183:8096/reporting/getCountOfNoShowAppointment/2024-01-12';
...
const callApiAndGetInteger = () => {
  ...
  .then((arrayFromJSON) => {
    ...
    console.log(providerid);
      ...
      if (providerid) {
        console.log(providerid);
          const apiUrlProviders = `http://52.14.102.183:8096/reporting/getCountOfCancelledAppointmentByProviderId/${providerid}/2024-01-12`;
...
const callApiAndGetInteger6 = () => {
  ...
  const handleSpeak = (word,voiceIndex=0) => {
    ...
    if (voices.length > voiceIndex) {
      ...
      if (word.toLowerCase().includes("page")&&word.toLowerCase().includes("ap")) {
        speechutterance.text = "The cancelled appointment is 0";
      } 
      else if (word.toLowerCase().includes("appointment")&&word.toLowerCase().includes("clinic")) {
        callApiAndGetInteger0();
      }
      else if (word.toLowerCase().includes("today")&&word.toLowerCase().includes("reschedule")) {
        callApiAndGetInteger1();
        
      }
      else if (word.toLowerCase().includes("vb")&&word.toLowerCase().includes("raj")) {
        callApiAndGetInteger();
      }
      else if (word.toLowerCase().includes("no")&&word.toLowerCase().includes("show")) {
        callApiAndGetInteger3();
      }
      else if (word.toLowerCase().includes("cancelled")&&word.toLowerCase().includes("today")) {
        callApiAndGetInteger4();
      
      }
      else if (word.toLowerCase().includes("reschedule")&&word.toLowerCase().includes("rush")) {
        callApiAndGetInteger5();

      }
      else if (word.toLowerCase().includes("no")&&word.toLowerCase().includes("show")&&word.toLowerCase().includes("niaz")) {
        callApiAndGetInteger6();
        
      }
      else if (word.toLowerCase().includes("appointments")&&word.toLowerCase().includes("today")) {
